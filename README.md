...
> All apps are part of my main ML portfolio repo:  
> 👉 <a href="https://github.com/Pinkkygold/Machine-Learning-projects"><b>Machine Learning Projects</b></a>
...
|------------------------|-----------------------------|--------------------|-----------------------------|
| Python, SQL, C++ | Power BI, Tableau, Matplotlib, Seaborn | Regression, Classification, SVM, XGBoost, KNN, Naive Bayes | MySQL, SQLite, Jupyter, VSCode |
| Pandas, NumPy, Scikit-Learn, Statsmodels | KPI Dashboards, Data Storytelling | Flask APIs, Model Deployment, Explainable AI | Anaconda, Virtual Envs |
